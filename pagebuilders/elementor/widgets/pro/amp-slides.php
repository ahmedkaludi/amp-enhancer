...
class AMP_Slides extends Base_Widget {
	...
	protected function render() {
		...
		foreach ( $settings['slides'] as $slide ) {
			...
			$slide_html .= '<div class="swiper-slide-contents fadeInUp">';
		...
		<div class="elementor-swiper">
			<div class="elementor-slides-wrapper elementor-main-swiper swiper-container swiper-container-horizontal" dir="<?php echo $direction; ?>" data-animation="<?php echo $settings['content_animation']; ?>">
				<div class="swiper-wrapper <?php esc_attr_e('swiper-wrapper'.$id);?> elementor-slides" data-transform-px="0" data-frame="0">
