...
class Amp_Accordion extends Widget_Base {
	...
	protected function render() {
		...
		?>
	   <amp-accordion class="elementor-accordion" role="tablist" disable-session-states expand-single-section animate>
			...
			foreach ( $settings['tabs'] as $index => $item ) :
				...
				<section class="elementor-accordion-item elementor-accordion" <?php echo ($tab_count == 1)?'expanded':'';?>>

					<h4 class="elementor-accordion-title elementor-tab-title">
                      ...
                      <?php if ( $settings['icon'] ) : ?>
						...
						<?php endif; ?>
					 <?php echo esc_html($item['tab_title']); ?></h4>
